...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Awesome Sauce!', 1], //From 90% to 99%
		['Awesome Sauce!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	private var healthBarOVER:AttachedSprite;
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("CherryBombOne-Regular.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		timeBarOVER = new AttachedSprite('timeBar');
		timeBarOVER.x = timeTxt.x;
		timeBarOVER.y = timeTxt.y + (timeTxt.height / 4);
		...
		healthBarOVER = new AttachedSprite('healthBar');
		healthBarOVER.y = FlxG.height * 0.89;
		healthBarOVER.screenCenter(X);
		healthBarOVER.scrollFactor.set();
		healthBarOVER.visible = !ClientPrefs.hideHud;
		healthBarOVER.xAdd = -4;
		healthBarOVER.yAdd = -4;
		add(healthBarOVER);
		if(ClientPrefs.downScroll) healthBarOVER.y = 0.11 * FlxG.height;
		...
		scoreTxt.setFormat(Paths.font("CherryBombOne-Regular.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("CherryBombOne-Regular.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
