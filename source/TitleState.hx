	...
	override public function create():Void
	{
		...
		if(ClientPrefs.checkForUpdates && !closedState) {
			...
			http.onData = function (data:String)
			{
				...
				var curVersion:String = SpriteMainMenuState.psychEngineVersion.trim();
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['adhdmultiverse', 'bobmac2011', 'thatboymyki', 'knitknotz', 'olliefnf', 'ajsonicmania']);
					#end
