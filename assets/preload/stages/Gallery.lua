...
function onCreate()
	...
	addArt('Sprite_Plush','Sprite Plush Sprites','0066CC',5,3, "Sprite idle dance")
  addArt('Sprite The Hedgeaphant render','Sprite Render','0066CC',5,3)

  addArt('Catnap Render','Catnap Render','FFA500',5,3)
